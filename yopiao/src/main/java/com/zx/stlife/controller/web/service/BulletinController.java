 ...
 */
@Controller
@RequestMapping(value="/service/bulletin")
public class BulletinController extends BaseController<Activity>{

	private static final String ACTIVITY = "service:bulletin";
	private static final String URI_PREFIX = "service/bulletin/bulletin-";
