...
<body>
<form:form action="${ctx}/notice/noticeMessage/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
		<thead>
			<tr class="success">
				...
				<th style="text-align: center; width: 10%">用户名称</th>
