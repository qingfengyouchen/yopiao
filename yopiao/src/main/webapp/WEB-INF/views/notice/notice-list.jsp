...
<body>
<form:form action="${ctx}/notice/notice/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	<div class="form-group" style="padding-top: 10px;">
		 	...
		 	<div class="col-sm-10">
				...
				<shiro:hasPermission name="notice:notice:edit">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
		<thead>
			<tr class="success">
				...
				<th style="text-align: center; width: 10%">发送人</th>
		...
		<tbody id="tbdContent">
			<jsp:include page="notice-list-content.jsp" flush="true"></jsp:include>
		</tbody>		
	</table>
 </form:form>
