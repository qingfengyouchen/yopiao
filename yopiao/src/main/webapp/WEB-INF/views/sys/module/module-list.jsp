...
<body>
<form:form action="${ctx}/sys/module/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	<div class="form-group" style="padding-top: 10px;">
	 	<label class="col-sm-2 control-label" style="float: left;">模块名称：</label>
	 	<div class="col-sm-10">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
		<thead>
			<tr class="success">
				...
				<th style="text-align: center; width: 60%">模块名称</th>
				<th style="text-align: center; width: 20%">序号</th>
				<th style="text-align: center; width: 20%">操作</th>
			</tr>
		</thead>
		<tbody id="tbdContent">
			<jsp:include page="module-list-content.jsp" flush="true"></jsp:include>
		</tbody>		
	</table>
 </form:form>
