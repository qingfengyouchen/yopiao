...
<body>
<form:form action="${ctx}/sys/role/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
		<thead>
			<tr class="success">
				...
				<th style="text-align: center; width: 60%">角色</th>
				<th style="text-align: center; width: 20%">序号</th>
				<th style="text-align: center; width: 20%">操作</th>
			</tr>
		</thead>
		<tbody id="tbdContent">
			<jsp:include page="role-list-content.jsp" flush="true"></jsp:include>
		</tbody>		
	</table>
 </form:form>
