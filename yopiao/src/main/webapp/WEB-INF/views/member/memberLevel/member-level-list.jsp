...
<body>
<form:form action="${ctx}/member/memberLevel/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	<div class="form-group" style="padding-top: 10px;">
		 	...
		 	<div class="col-sm-10">
				...
				<shiro:hasPermission name="member:memberLevel:edit">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
		<thead>
			<tr class="success">
				...
				<th style="text-align: center; width: 40%">会员等级名称</th>
				<th style="text-align: center; width: 20%">最小值</th>
				<th style="text-align: center; width: 20%">最大值</th>
				<th style="text-align: center; width: 20%">操作</th>
			</tr>
		</thead>
		<tbody id="tbdContent">
			<jsp:include page="member-level-list-content.jsp" flush="true"></jsp:include>
		</tbody>		
	</table>
 </form:form>
...
<jsp:include page="/common/operate-msg.jsp" flush="true"></jsp:include>
   ...
   $(function(){
		$table = $('#contentTable').initTable({
			namespace: '${ctx}/member/memberLevel',
			formId:'frmSearch',
