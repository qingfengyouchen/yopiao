...
<body>
<form:form action="${ctx}/member/member/redpack" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
		...
		<tbody id="tbdContent">
			<jsp:include page="member-redpack-content.jsp" flush="true"></jsp:include>
		</tbody>		
	</table>
 </form:form>
