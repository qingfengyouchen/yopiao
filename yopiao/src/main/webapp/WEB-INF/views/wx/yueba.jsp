...
<div class="date w_100">
	<div class="date-top">
    	<div class="date-top-search"><input type="text" value="" placeholder="" /><div class="tips"><span><img src="${rootUri}/static/wx/images/search_icon01.png" /></span>搜索好友或内容</div></div>
        <script>
			$(".date-top-search .tips").click(function(){
				$(this).parent().find("input").focus();
			});
        	$(".date-top-search input").focus(function(){
        ...
        <div class="date-top-img"><img src="${rootUri}/static/wx/images/hyzx_banner.jpg" /></div>
    </div>
    <div class="date-nav">
    	<ul class="clearfix">
    ...
    <div class="data-main">
    	...
    	<div class="data-main-item active">
        	...
        	<div class="date-comlist mb10">
                ...
                <div class="user-reply-seeall"><a href="${rootUri}/wx/url?url=msgdetail">查看全部12条评论</a></div>
            </div>
            <!--循环1 结束-->
            <!--循环1-->
        	<div class="date-comlist mb10">
