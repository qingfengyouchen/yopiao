...
<!--头部通用 结束-->
<!--修改密码主体部分 开始-->
<div class="hyzx-tixian w_100">
	<ul class="clearfix">
    	<li class="first mb10"><img src="${rootUri}/static/wx/images/tixian_icon01.png" /><p>中国银行<br />尾号1234储蓄卡</p></li>
    	<li><span class="title">到账时间</span><p>24小时内</p></li>
        <li><span class="title">转出金额</span><p><input type="text" class="comtxt" value="" placeholder="账户内可转出金额112元" /></p></li>
    </ul>
    <div class="hyzx-changepass-confirm"><input class="combtn btnbg" type="button" value="确认转出" /></div>
</div>
<!--修改密码主体部分 结束-->
