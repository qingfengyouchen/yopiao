...
<div class="hyzx-changepass w_100">
	<ul class="clearfix">
    	<li><span class="title">原密码：</span><input class="comtxt" type="password" value="" placeholder="请输入原始密码" /></li>
        <li><span class="title">新密码：</span><input class="comtxt" type="password" value="" placeholder="请输入新密码" /></li>
        <li><span class="title">确认密码：</span><input class="comtxt" type="password" value="" placeholder="请确认新密码" /></li>
    </ul>
