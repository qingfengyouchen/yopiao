...
<div class="pay-resault w_100">
	<div class="pay-resault-box"><img src="${rootUri}/static/wx/images/icon_success.png"></div>
    <div class="pay-resault-text">
        <p>恭喜您，提交成功</p>
        <p>约票客服将尽快审核您的资料</p>
    </div>
    <div class="pay-resault-btn">
        <a href="${rootUri}/wx/url?url=wxhome"><input type="button" class="combtn btnbg3" value="个人中心" /></a>
    </div>
</div>
<!--订票服务协议主体部分 结束-->
