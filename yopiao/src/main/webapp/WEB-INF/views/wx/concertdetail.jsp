...
<div class="ych-detail w_100">
	<div class="ych-detail-item mb10">
    	<div class="ych-detail-comtitle">演唱会简介：</div>
    ...
    <div class="ych-detail-item">
        <div class="ych-detail-comtitle">场馆介绍：</div>
        <div class="ych-detail-place">
        	<ul class="clearfix">
            <li><div class="img"><img src="${rootUri}/static/wx/images/ych_detail_place_img01.jpg" /></div><div class="right"><a href="${rootUri}/wx/url?url=venues"><h3>约票科技中心</h3><p>地址：北京市体育中心</p></a></div></li>
            </ul>
        </div>
    </div>    
</div>
