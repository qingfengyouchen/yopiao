...
<link rel="stylesheet" type="text/css" href="${rootUri}/static/wx/css/awesome/font-awesome.min.css">
...
<!--头部通用 结束-->
<!--消息提醒主体部分 开始-->
<div class="date-tips w_100">
	<ul>
    	<li><h3><i class="icon-envelope"></i> 您购买的某某某某票已发货，请注意查收</h3></li>
        <li><h3><i class="icon-bell"></i> 某某某某粉丝刚刚关注了你</h3></li>
        <li><h3><i class="icon-truck"></i> 您购买的某某某某票已发货，请注意查收</h3></li>
        <li><h3><i class="icon-bell"></i> 某某某某粉丝刚刚关注了你</h3></li>
    </ul>
</div>
<!--消息提醒主体部分 结束-->
