...
<div class="nry-main w_100">
	<div class="nry-top">
        ...
        <div class="jj orangebg">预售中 &gt;<span>预售订金：</span>100-800元<span>剩余：</span>100张</div>
    </div>
    ...
    <div class="nry-tkprovider mb10">
        ...
        <ul class="clearfix">
        	<li><div class="img"><a href="${rootUri}/wx/url?url=merchants"><img src="${rootUri}/static/wx/images/nry_tkprovider_img01.jpg" /></a></div><div class="right"><h4><a href="#" class="follow"><img src="${rootUri}/static/wx/images/follow_icon01.png" />关注</a><a href="#" class="name">票商名称</a></h4><p><span>剩余：<i>100张</i></span>价格：<i>￥1500元</i></p></div></li>
            <li><div class="img"><a href="${rootUri}/wx/url?url=merchants"><img src="${rootUri}/static/wx/images/nry_tkprovider_img01.jpg" /></a></div><div class="right"><h4><a href="#" class="follow on"><img src="${rootUri}/static/wx/images/follow_icon02.png" />已关注</a><a href="#" class="name">票商名称</a></h4><p><span>剩余：<i>100张</i></span>价格：<i>￥1500元</i></p></div></li>
            <li><div class="img"><a href="${rootUri}/wx/url?url=merchants"><img src="${rootUri}/static/wx/images/nry_tkprovider_img01.jpg" /></a></div><div class="right"><h4><a href="#" class="follow on"><img src="${rootUri}/static/wx/images/follow_icon02.png" />已关注</a><a href="#" class="name">票商名称</a></h4><p><span>剩余：<i>100张</i></span>价格：<i>￥1500元</i></p></div></li>
        </ul>
    </div>
    ...
    <div class="nry-foot"><a href="${rootUri}/wx/url?url=posterqa">查看更多疑问</a><a href="javascript:;" id="user-ask">我要提问</a></div>
    <div class="hg71"></div>
...
<div class="nry-tc-buydetail" id="nry-tc-buydetail">
    ...
    <div class="tc-top">
        ...
        <div class="right">
            <h3>张惠妹乌托邦演唱会</h3>
            <p><span class="grey">库存：</span><span class="orange">100张</span></p>
    ...
    <div class="tc-detail mb10">
       ...
       <dl class="clearfix">
        	<dt>预售订金：</dt>
            <dd><a href="#" class="active">100</a></dd>
        </dl>
    </div>
    <div class="tc-num clearfix"><span>数量：</span><a class="down">-</a><input class="numtxt" type="text" value="1" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"><a class="up">+</a><span>合计：<strong class="orange">100元</strong></span></div>
    <input onclick="location.href='${rootUri}/wx/url?url=addorders'" class="combtn btnbg" type="button" value="下一步" />
</div>
