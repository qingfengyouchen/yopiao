...
<div class="order-detail w_100">
	<div class="order-detail-top">
    	<h3>买家已付款<br>等待卖家发货</h3>
        <img src="${rootUri}/static/wx/images/order_detail_icon02.png" />
    </div>
    ...
    <div class="order-detail-ft01">
       <div class="l">1张</div>
       <div class="r">合计：<span class="orange">1500</span>元</div>
    </div>
    <div class="order-detail-ft01">
       
       <div class="r"><a href="#" class="orderbtn2">申请退款</a><a href="#" class="orderbtn1">提醒发货</a></div>
    </div>
</div>
<!--订单详情主体部分 结束-->
