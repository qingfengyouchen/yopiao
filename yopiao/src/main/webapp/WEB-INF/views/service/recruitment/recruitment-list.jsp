...
<form:form action="${ctx}/service/recruitment/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
		<thead>
			<tr class="success">
				...
				<th style="text-align: center; width: 20%">招聘标题</th>
				<th style="text-align: center; width: 10%">职业</th>
				<th style="text-align: center; width: 10%">要求</th>
		...
		<tbody id="tbdContent">
			<jsp:include page="recruitment-list-content.jsp" flush="true"></jsp:include>
		</tbody>		
	</table>
 </form:form>
   ...
   $(function(){
		$table = $('#contentTable').initTable({
			namespace: '${ctx}/service/recruitment',
			formId:'frmSearch',
