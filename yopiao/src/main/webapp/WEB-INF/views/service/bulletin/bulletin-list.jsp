...
<form:form action="${ctx}/service/bulletin/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
		<thead>
			<tr class="success">
				...
				<!-- 
				<th style="text-align: center; width: 20%">公告时间</th>
				<th style="text-align: center; width: 17%">公告状态</th>
				 -->
				<th style="text-align: center; width: 30%">操作</th>
			</tr>
		</thead>
		<tbody id="tbdContent">
			<jsp:include page="bulletin-list-content.jsp" flush="true"></jsp:include>
		</tbody>		
	</table>
 </form:form>
   ...
   $(function(){
		$table = $('#contentTable').initTable({
			namespace: '${ctx}/service/bulletin',
			formId:'frmSearch',
    ...
    function updateState(id){
    	Public.confirm("确定要结束活动", function(){
	    	$.post("${ctx}/service/bulletin/update",{id:id},function(state){
