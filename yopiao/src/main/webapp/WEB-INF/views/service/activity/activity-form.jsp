		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>
						E购管理 > ${empty entity.id ? "新增" : "修改"}E购活动
					</h5>
				</div>
				<div class="ibox-content">
					<form:form id="inputForm" modelAttribute="entity" action="${ctx}/service/activity/save" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">设定人数</label>
							<div class="col-sm-6">
								<form:input path="maxJoinAmount" cssClass="form-control" placeholder="请输入1-20个字符" autocomplete="off"/>
							</div>
							<label class="col-sm-4 control-label hint" style="text-align: left;"> </label>
						</div>
						<div class="hr-line-dashed"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<form:input path="address" cssClass="form-control" placeholder="请输入1-64个英文、数字或下划线" autocomplete="off"/>
							</div>
							<label class="col-sm-4 control-label hint" style="text-align: left;"> </label>
						</div>
						-->
					    ...
					    <div class="hr-line-dashed"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label">详情图:750*600像素</label>
							<div class="col-sm-6">
								<div id="fileList2" class="uploader-list">
									<c:if test="${not empty entity.imgUrl}">
										<div class="file-item thumbnail" tmpImgId="${entity.id}">
											<img src="${activityRootUri}/${entity.imgUrl}" style="width:135px;">
											<div class="del" onclick="delImg(this, 'imgUrl')">X</div>
										</div>
									</c:if>
								</div>
								<div id="filePicker2" style="display: ${empty entity.imgUrl ? "" : "none"};">
									<button class="btn btn-success " type="button"><i class="fa fa-upload"></i>&nbsp;&nbsp;<span class="bold">上传图片</span></button>								
								</div>
							</div>
							<label class="col-sm-4 control-label hint" style="text-align: left;"> </label>
	...
	$(document).ready(function() {
		...
		$("#inputForm").validate({
			...
			messages:{
				...
				maxJoinAmount: {
                    required: icon + "请设定人数",
                    minlength: icon + "人数最少1个字符",
                    maxlength: icon + "人数最多20个字符"
				},
				activityTime:{
				...
				address:{
                    ...
                    minlength: icon + "活动地址最少1个字符",
                    maxlength: icon + "活动地址最多64个字符"
				}
			},
        	errorPlacement:function(error,element) {  
