...
<html>
	...
	<div class="max-box">
          <div class="tab">
             <ul>              
               <li class="p-line primary">家教</li>
               <li class="p-line-h tab-p"><a href="${ctx}/service/tutoring/coachingList" target="_self" class="block">补习</a></li>
             </ul>
          </div>
          <!-- 菜单栏结束 -->
          <div class="main">
            <ul class="main_f">
             <c:forEach items="${page.result}" var="entity">
	              <li class="line clearfloat">
	                    <a href="${staticHtmlRootUri}/${tutoring}/${ entity.htmlUrl}" target="_self" >
	                      <div class="con">
