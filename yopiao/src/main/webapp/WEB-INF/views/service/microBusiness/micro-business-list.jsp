...
<body>
<form:form action="${ctx}/service/microBusiness/list" id="frmSearch" cssClass="form-horizontal"  modelAttribute="paramsEntity">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
        ...
        <tr class="success">
            ...
            <th style="text-align: center; width: 20%">微商名称</th>
        ...
        <tbody id="tbdContent">
        	<jsp:include page="micro-business-list-content.jsp" flush="true"></jsp:include>
		</tbody>
    </table>	
 </form:form>
   ...
   $(function(){
		$table = $('#contentTable').initTable({
			namespace: '${ctx}/service/microBusiness',
			formId:'frmSearch',
