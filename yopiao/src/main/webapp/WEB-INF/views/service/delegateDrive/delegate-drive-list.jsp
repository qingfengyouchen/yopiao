...
<body>
<form:form action="${ctx}/service/delegateDrive/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
		...
		<tbody id="tbdContent">
			<jsp:include page="delegate-drive-list-content.jsp" flush="true"></jsp:include>
		</tbody>		
	</table>
 </form:form>
...
<jsp:include page="/common/operate-msg.jsp" flush="true"></jsp:include>
   ...
   $(function(){
		$table = $('#contentTable').initTable({
			namespace: '${ctx}/service/delegateDrive',
			formId:'frmSearch',
