		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>
						E购管理 > ${empty entity.id ? "新增" : "修改"}E购商业
					</h5>
				</div>
				<div class="ibox-content">
					<form:form id="inputForm" modelAttribute="entity" action="${ctx}/service/businessInfo/save" method="post" class="form-horizontal">
						<form:hidden path="id"/>
						<div class="form-group">
							<label class="col-sm-2 control-label">E购商业类别</label>
							<div class="col-sm-6">
								<form:select path="type" cssClass="form-control">
									<form:options items="${businessInfoMap}"/>
								</form:select>
							</div>
