...
<body>
<form:form action="${ctx}/service/businessInfo/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	<div class="form-group" style="padding-top: 10px;">
			<label class="col-sm-1 control-label">类别：</label> 
	        <div class="col-sm-2">
	        	<form:select path="params[type]" cssClass="form-control">
	            	<form:option value="">全部</form:option>
	                <form:options items="${businessInfoMap}"></form:options>
	            </form:select>
	        </div>    
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
        ...
        <tbody id="tbdContent">
        	<jsp:include page="business-info-list-content.jsp" flush="true"></jsp:include>
		</tbody>
    </table>	
 </form:form>
   ...
   $(function(){
		$table = $('#contentTable').initTable({
			namespace: '${ctx}/service/businessInfo',
			formId:'frmSearch',
