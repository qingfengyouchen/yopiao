...
<body>
<form:form action="${ctx}/service/convenience/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
        ...
        <tr class="success">
            ...
            <th style="text-align: center; width: 30%">联系人</th>
            <th style="text-align: center; width: 20%">联系电话</th>
            <th style="text-align: center; width: 20%">操作</th>
        </tr>
        </thead>
        <tbody id="tbdContent">
        	<jsp:include page="convenience-list-content.jsp" flush="true"></jsp:include>
		</tbody>
    </table>	
 </form:form>
   ...
   $(function(){
		$table = $('#contentTable').initTable({
			namespace: '${ctx}/service/convenience',
			formId:'frmSearch',
