...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/ueditor/third-party/webuploader/webuploader.css">
</head>
		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<form:form id="inputForm" modelAttribute="entity" action="${ctx}/service/rooftopGossip/save" method="post" class="form-horizontal">
						<form:hidden path="id"/>
