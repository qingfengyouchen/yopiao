...
<body>
<form:form action="${ctx}/service/rooftopGossip/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
        ...
        <tbody id="tbdContent">
        	<jsp:include page="rooftop-gossip-list-content.jsp" flush="true"></jsp:include>
		</tbody>
    </table>	
 </form:form>
   ...
   $(function(){
		$table = $('#contentTable').initTable({
			namespace: '${ctx}/service/rooftopGossip',
			formId:'frmSearch',
