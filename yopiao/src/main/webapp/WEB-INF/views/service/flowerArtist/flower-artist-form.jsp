		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>
						E购管理 > ${empty entity.id ? "新增" : "修改"}鲜花速递
					</h5>
				</div>
				<div class="ibox-content">
					<form:form id="inputForm" modelAttribute="entity" action="${ctx}/service/flowerArtist/save" method="post" class="form-horizontal">
						<form:hidden path="id"/>
						...
						<div class="hr-line-dashed"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label">送货范围</label>
							<div class="col-sm-6">
								<form:input path="sendRange" cssClass="form-control" placeholder="请输入1-60个字符" autocomplete="off"/>
							</div>
							<label class="col-sm-4 control-label hint" style="text-align: left;"> </label>
						</div>
						<div class="hr-line-dashed"></div>
        ...
        $(function(){
            ...
            $("#inputForm").validate({
                ...
                messages: {
                    ...
                    sendRange:{
                        required: icon + "请输入送货范围",
                        minlength: icon + "送货范围最少1个字符",
                        maxlength: icon + "送货范围最多60个字符"
                    }
                },
            	errorPlacement:function(error,element) {  
