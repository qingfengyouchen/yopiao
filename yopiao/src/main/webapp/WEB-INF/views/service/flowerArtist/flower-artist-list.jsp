...
<body>
<form:form action="${ctx}/service/flowerArtist/list" id="frmSearch" cssClass="form-horizontal" modelAttribute="paramsEntity">
	...
	<table id="contentTable" class="table table-hover table-striped table-bordered table-condensed">
		<thead>
			<tr class="success">
				...
				<th style="text-align: center; width: 18%">送货范围</th>
		...
		<tbody id="tbdContent">
			<jsp:include page="flower-artist-list-content.jsp" flush="true"></jsp:include>
		</tbody>		
	</table>
 </form:form>
   ...
   $(function(){
		$table = $('#contentTable').initTable({
			namespace: '${ctx}/service/flowerArtist',
			formId:'frmSearch',
