...
<%@include file="/common/taglibs.jsp" %>
		<c:forEach items="${page.result}" var="entity">
			<tr>
				...
				<td style="text-align: center;">${entity.age}&nbsp;</td>
				<td style="text-align: center;">${entity.education}&nbsp;</td>
				<td style="text-align: center;">${entity.workExperience}&nbsp;</td>
				<td style="text-align: center;">${entity.apartmentAddr}&nbsp;</td>
