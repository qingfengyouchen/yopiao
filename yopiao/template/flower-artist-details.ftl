    ...
    <body>
       <div class="max-box" style="background:#EFEFF4;">
          ...
          <div class="main">
             <div class="info">
                <dl>
                  <dt class="largest blank plr">${flowerArtist.title}</dt>
                  <dd class="large text-low2 plr">送货范围：${flowerArtist.sendRange}</dd>
                  <dd class="plr text-low2"><b class="large">${flowerArtist.editTime?string("yyyy-MM-dd")}</b></dd>
                </dl>
             </div>
             <div class="info2">
                <h5 class="largest_plus text-low2"><ins class="ins"></ins>简介</h5>
                ${flowerArtist.content}
             </div>
             <div class="k-z"></div>
             <div class="tel largest">
                <a  href="tel://${flowerArtist.tel}" class="text-f"><del></del>
                拨打电话</a>
             </div>
          </div>
       </div>
