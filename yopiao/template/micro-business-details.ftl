    ...
    <body>
       <div class="max-box" style="background:#EFEFF4;">
          <div class="main">
             <div class="info">
                <dl>
                  <dt class="largest blank plr">${entity.name}</dt>
                  <dd class="large text-low2 plr">${entity.title}</dd>
                  <dd class="plr text-low2 large"><b>${entity.createTime?string("yyyy-MM-dd")}</b></dd>
                </dl>
             </div>
             <div class="info2">
             ...
             <div class="tel largest">
               <a  href="tel://${entity.tel}" class="text-f"><del></del>
                拨打电话</a>
             </div>
          </div>
       </div>
