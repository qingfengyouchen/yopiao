...
public class ReflectionsTest {
	...
	public void invokeMethod() {
		...
		assertThat(
				Reflections
						.invokeMethod(bean, "privateMethod", new Class[]{String.class}, new Object[]{"micheal cao"}))
				.isEqualTo("hello micheal cao");

		// 仅匹配函数名
		assertThat(Reflections.invokeMethodByName(bean, "privateMethod", new Object[]{"micheal cao"})).isEqualTo(
				"hello micheal cao");

		// 函数名错
		try {
			Reflections.invokeMethod(bean, "notExistMethod", new Class[] { String.class }, new Object[] { "micheal cao"});
			failBecauseExceptionWasNotThrown(IllegalArgumentException.class);
		} catch (IllegalArgumentException e) {
		...
		// 参数类型错
		try {
			Reflections.invokeMethod(bean, "privateMethod", new Class[] { Integer.class }, new Object[] { "micheal cao"});
		...
		// 函数名错
		try {
			Reflections.invokeMethodByName(bean, "notExistMethod", new Object[] { "micheal cao"});
			failBecauseExceptionWasNotThrown(IllegalArgumentException.class);
		} catch (IllegalArgumentException e) {
